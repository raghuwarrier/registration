...
httpMockApp.run(function($httpBackend) {
    ...
    // Passed through calls for which mocking is not required.
        ...
        $httpBackend.whenGET('http://127.0.0.1:62303/app/data/overview.json').passThrough();
        $httpBackend.whenGET('milestoneDetails.html').passThrough();
        $httpBackend.whenGET('http://127.0.0.1:62303/app/data/milestone.json').passThrough();
        $httpBackend.whenPOST('http://95.129.84.229/icontrol/overview').passThrough();
        $httpBackend.whenPOST('http://95.129.84.229/icontrol/status').passThrough();
});
